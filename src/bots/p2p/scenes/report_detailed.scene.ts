...
import { ReportStrategiesService } from '../strategy/report-strategy.service';
import { ReportTriggersService } from '../strategy/triggers/report-trigger.service';

@Injectable()
@Scene('report_detailed')
export class ReportDetailedScene {
  ...
  async enter(@Ctx() ctx: SceneContext) {
    const trigger = this.triggerService
      .getAll()
      .find((t) => t.type === 'capacity-detailed');
